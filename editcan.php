...
$id=$_REQUEST['id'];
$query = "SELECT * from candidate where uid='".$id."'"; 
...
$prev_acc=$_REQUEST['prev_acc'];
$update="update candidate set name='".$name."', age=".$age.", mobile_no=".$mobile_no.", zone='".$zone."', address='".$address."', qualification='".$qualification."', prev_acc='".$prev_acc."', gender='".$gender."', income=".$income." where uid='".$id."'";
mysqli_query($conn, $update) or die(mysqli_error($conn));
$status = "Record Updated Successfully. </br></br>
<a href='updatecandidate.php'>View Updated Record</a>";
...
<p><input type="text" name="qualification" placeholder="Enter Your Qualification" 
required value="<?php echo $row['qualification'];?>" /></p>
<p><input type="text" name="prev_acc" placeholder="Enter Your Prevoius Accomplishments" 
required value="<?php echo $row['prev_acc'];?>" /></p>
<p><input type="number" name="income" placeholder="Enter Annual Income" 
required value="<?php echo $row['income'];?>" /></p>
