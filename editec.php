...
$id=$_REQUEST['id'];
$query = "SELECT * from ec where uname='".$id."'"; 
...
$name =$_REQUEST['name'];
$post =$_REQUEST['post'];
$update="update ec set name='".$name."', post='".$post."' where uname='".$id."'";
mysqli_query($conn, $update) or die(mysqli_error($conn));
$status = "Record Updated Successfully. </br></br>
<a href='updateec.php'>View Updated Record</a>";
...
<input name="id" type="hidden" value="<?php echo $row['uname'];?>" />
<p><input type="text" name="name" placeholder="Enter Name" 
required value="<?php echo $row['name'];?>" /></p>
<p><input type="text" name="post" placeholder="Enter Post" 
required value="<?php echo $row['post'];?>" /></p>
