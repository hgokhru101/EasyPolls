...
<body>
    ...
    <table width="100%" border="3" style="border-collapse:collapse;">
        <thead>
            <tr>
                <th><strong>Officer-Id</strong></th>
    ...
    <tbody>
    <?php
        $sel_query="Select * from ec ORDER BY name desc;";
        $result = mysqli_query($conn,$sel_query);
        while($row = mysqli_fetch_assoc($result)) { ?>
            <tr><td align="center"><?php echo $row["eid"]; ?></td>
                <td align="center"><?php echo $row["uname"]; ?></td>
                <td align="center"><?php echo $row["name"]; ?></td>
                <td align="center"><?php echo $row["post"]; ?></td>
                <td align="center">
                    <a href="editec.php?id=<?php echo $row["uname"]; ?>">Edit</a>
                </td>
                <td align="center">
                    <a href="delete.php?id=<?php echo $row["uname"]; ?>">Delete</a>
                </td>
            </tr>
            <?php } ?>
    </tbody>
